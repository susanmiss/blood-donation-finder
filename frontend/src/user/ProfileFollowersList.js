                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <Link to={`/user/${person._id}`}>
                                            <img src={Avatar}  className="float-left mb-2 mr-2" alt={person.name} style={{width: "40px"}} />
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <Link to={`/dashboard-user/${person._id}`}>
                                            <img className="float-left mb-2 mr-2" src={Avatar} alt={person.name} style={{width: "40px"}}/>
                                             <p style={{textAlign: "left"}}>{person.name}</p>
                                        </Link>
                                    </div>
