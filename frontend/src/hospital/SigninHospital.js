...
class SigninHospital extends Component {
    ...
    render(){
        ...
        if(redirect){
            return <Redirect to={`/dashboard-hospital/${isAuthenticated().hospital._id}`}/>
        }
        ...
        return (
            <div className="container">
                ...
                <form>
                    ...
                    <button onClick={this.clickSubmit} className="btn btn-raised  btn-block" style={{backgroundColor: "rgb(234, 181, 178)"}}>Login</button>
                </form>
            </div>
        )
    }
